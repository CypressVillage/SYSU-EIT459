...
scStr.simulation.sweepValue                 = 80;      % Define parameter values to sweep over. A good starting point for the pathloss is 150 to 110.
...
scStr.simulation.userVelocity               = 10/3.6;                        % UE velocity in m/s
...
scStr.channel.powerDelayProfile             = 'SUI-6';  
scStr.channel.K                             = 0;
